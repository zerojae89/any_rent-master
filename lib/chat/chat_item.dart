...
class _ChatItemState extends State<ChatItem> {
      ...
      child: Card(
        child: Container(
          ...
          child: Row(
            ...
            children: [
              Expanded(flex: 2, child: (prfSeq == null) ? Icon(Icons.account_box_rounded, size: defaultSize * 8,) :
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(nicNm ?? '', style: TextStyle(fontSize: defaultSize * 1.7),), //유저 닉네임으로 해야함
                          Text(twmNm ?? '', style: TextStyle(fontSize: defaultSize * 1.7),), //job 동네 이름으로 해야함
                          Text('${screenDate ?? ''}', style: TextStyle(fontSize: defaultSize * 1.7),) //마지막 시간이 오늘이 아니면 날짜 오늘이면 시간으로 표시
                        ],
                      ),
                    ),
                    Container(
  ...
  Widget textView (defaultSize, chatCnt){
    ...
    return Text(chatCnt, style: TextStyle(fontSize: defaultSize * 1.4), );
  }
}